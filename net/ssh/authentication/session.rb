...
require Rails.root.join('net/ssh/authentication/constants.rb')
require Rails.root.join('net/ssh/authentication/key_manager.rb')
require Rails.root.join('net/ssh/authentication/methods/none.rb')
require Rails.root.join('net/ssh/authentication/methods/publickey.rb')
require Rails.root.join('net/ssh/authentication/methods/hostbased.rb')
require Rails.root.join('net/ssh/authentication/methods/password.rb')
require Rails.root.join('net/ssh/authentication/methods/keyboard_interactive.rb')
