...
require Rails.root.join('net/ssh/packet.rb')
require Rails.root.join('net/ssh/buffered_io.rb')
require Rails.root.join('net/ssh/connection/channel.rb')
require Rails.root.join('net/ssh/connection/constants.rb')
