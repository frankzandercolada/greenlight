...
require Rails.root.join('net/sftp/constants.rb')
require Rails.root.join('net/sftp/errors.rb')
require Rails.root.join('net/sftp/protocol.rb')
require Rails.root.join('net/sftp/request.rb')
require Rails.root.join('net/sftp/operations/dir.rb')
require Rails.root.join('net/sftp/operations/upload.rb')
require Rails.root.join('net/sftp/operations/download.rb')
require Rails.root.join('net/sftp/operations/file_factory.rb')
