require Rails.root.join('net/sftp/protocol/01/base.rb')
require Rails.root.join('net/sftp/protocol/02/base.rb')
require Rails.root.join('net/sftp/protocol/03/base.rb')
require Rails.root.join('net/sftp/protocol/04/base.rb')
require Rails.root.join('net/sftp/protocol/05/base.rb')
require Rails.root.join('net/sftp/protocol/06/base.rb')
