...
require Rails.root.join('net/sftp/packet.rb')
require Rails.root.join('net/sftp/protocol/base.rb')
require Rails.root.join('net/sftp/protocol/01/attributes.rb')
require Rails.root.join('net/sftp/protocol/01/name.rb')
