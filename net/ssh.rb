...
require Rails.root.join('net/ssh/config.rb')
require Rails.root.join('net/ssh/errors.rb')
require Rails.root.join('net/ssh/loggable.rb')
require Rails.root.join('net/ssh/transport/session.rb')
require Rails.root.join('net/ssh/authentication/session.rb')
require Rails.root.join('net/ssh/connection/session.rb')
require Rails.root.join('net/ssh/prompt.rb')
